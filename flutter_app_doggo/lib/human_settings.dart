                                    ...
                                    decoration: BoxDecoration(
                                      image: DecorationImage(
                                        image: (_humanImageURL == null
                                            ...
                                            : (personImage == null
                                                ? CachedNetworkImageProvider(_humanImageURL)
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  ...
                  colors: [Colors.orange[300], Colors.orange[200], Colors.orange[100]],
                ),
                borderRadius: BorderRadius.circular(20),
              ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextButton(
                      ...
                      onPressed: () {
                        _overlayEntry.remove();
                        Navigator.pushNamedAndRemoveUntil(context, '/addDog/${widget._currentUid}', (route) => false);
                      },
                      child: Text(
                        "Добавить собаку",
                        style: TextStyle(
